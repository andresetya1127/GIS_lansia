...
@section('content')
    ...
    <x-base.card>
        <form action="{{ route('lansia.store', $data->uuid) }}" method="POST" id="form-lansia" enctype="multipart/form-data">
            @csrf
            <div class="row row-cols-sm-1 row-cols-lg-2">
                ...
                <x-forms.input label="Umur" :value="$data->umur" readonly name="umur"/>
                ...
                <x-forms.input name="rt" label="RT" type="number" :value="$data->rt"
                    highlight="Jika tidak ada silahkan isi 00" />
                <x-forms.input name="rw" label="RW" type="number" :value="$data->rw"
                    highlight="Jika tidak ada silahkan isi 00" />
            </div>

            <x-forms.textarea name="alamat" label="Alamat" :value="$data->alamat" />
            <div class="">
                <x-forms.input type="file" name="profile" label="Foto" />
            </div>
